...
@endif
    ...
    @if(!isset($show_all_notifications))
        <div x-show="open"
            ...
            class="absolute top-0 right-0 max-w-lg mt-20 overflow-hidden origin-top-right transform rounded-lg shadow-lg max-w-full w-104" x-cloak>
    @else
        <div class="relative top-0 right-0 w-full my-8 overflow-hidden origin-top max-w-full">
    @endif
