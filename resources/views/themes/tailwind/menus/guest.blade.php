<nav class="navbar flex items-center justify-end flex-1 hidden w-full h-full space-x-32 md:flex">
    ...
    <a href="{{ route('register') }}" class="text-base font-medium leading-6 text-white transition duration-150 ease-in-out hover:text-wave-600 focus:outline-none focus:text-wave-600">
        Pricing
    </a>
    <a href="{{ route('wave.blog') }}" style="margin-left: 120px" class="text-base font-medium leading-6 text-white transition duration-150 ease-in-out hover:text-wave-600 focus:outline-none focus:text-wave-600">
        Contact Us
    </a>
    ...
    <span class="inline-flex rounded-md">
        <a href="{{ route('login') }}" style="color: #F5C003; margin-left: 100px" class="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 whitespace-no-wrap transition duration-150 ease-in-out border border-transparent rounded-md bg-white">
            Log-in
        </a>
    </span>
</nav>
